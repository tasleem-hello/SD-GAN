...
from sdgancore.wing import FAN
...
def build_model(args):
    ...
    Samling_network = nn.DataParallel(SamplingModule(args.latent_dim, args.style_dim, args.num_domains))
    style_encoder = nn.DataParallel(StyleEncoder(args.img_size, args.style_dim, args.num_domains))
    discriminator = nn.DataParallel(Discriminator(args.img_size, args.num_domains))
    generator_ema = copy.deepcopy(generator)
    Samling_network_ema = copy.deepcopy(Samling_network)
    style_encoder_ema = copy.deepcopy(style_encoder)

    nets = Munch(generator=generator,
                 Samling_network=Samling_network,
                 style_encoder=style_encoder,
                 discriminator=discriminator)
    nets_ema = Munch(generator=generator_ema,
                     Samling_network=Samling_network_ema,
